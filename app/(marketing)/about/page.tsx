                ...
                <div>
                  ...
                  <div className="flex justify-center gap-6">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group relative inline-flex items-center gap-3 px-8 py-4 bg-white border-2 border-gray-200 text-gray-800 rounded-2xl hover:border-orange-300 hover:bg-orange-50 transition-all duration-300 font-semibold hover:scale-105 text-lg shadow-md hover:shadow-xl"
                    >
                      <div className="relative">
                        <div className="w-6 h-6 bg-gradient-to-br from-orange-400 via-pink-500 to-purple-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      ...
                      <span className="group-hover:text-orange-600 transition-colors duration-300">Follow on Instagram</span>
                    </a>
                  </div>
                </div>
              </div>
